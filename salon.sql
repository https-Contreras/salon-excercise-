...
--
-- Name: appointments fkcustomers; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT fkcustomers FOREIGN KEY (customer_id) REFERENCES public.customers(customer_id);


--
-- Name: appointments fkservices; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT fkservices FOREIGN KEY (service_id) REFERENCES public.services(service_id);
